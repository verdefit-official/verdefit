...
const documents = [
  ...
  // ── ブログ SEO ───────────────────────────────────────────────────
  {
    _id: "blogSeo",
    _type: "blogSeo",
    pageTitle: "横手市の整体・パーソナルジムの健康ブログ｜VERDE FIT公式ブログ",
    metaDescription:
    ...
    ogTitle: "横手市の整体・パーソナルジムの健康ブログ｜VERDE FIT公式ブログ",
    ogDescription:
      "横手市の整体・パーソナルジムVERDE FITの公式ブログ。腰痛・肩こり・姿勢改善など身体の不調改善や、ダイエット・トレーニング方法など健康づくりに役立つ情報を整体師・トレーナーが発信しています。",
  },
  ...
  // ── ブログ ヒーロー ──────────────────────────────────────────────
  {
    ...
    primaryButtonText: "無料体験",
    secondaryButtonText: "LINE相談",
  },
  ...
  // ── ブログ紹介 ───────────────────────────────────────────────────
  {
    _id: "blogIntro",
    _type: "blogIntro",
    heading: "身体の悩みを解決する健康ブログ",
    tags: ["肩こり", "腰痛", "姿勢", "ダイエット", "運動不足"],
    descriptions:
  ...
  // ── 整体ブログセクション ─────────────────────────────────────────
  {
    _id: "blogSeitaiSection",
    _type: "blogSeitaiSection",
    sectionTitle: "整体師が解説する身体改善ブログ",
    subheading: "〜肩こり・腰痛・姿勢改善のヒント〜",
    linkText: "整体の記事をもっと見る",
  },

  // ── パーソナルトレーニングブログセクション ──────────────────────
  {
    _id: "blogPersonalSection",
    _type: "blogPersonalSection",
    sectionTitle: "パーソナルトレーナーが解説するトレーニングブログ",
    subheading: "",
    linkText: "パーソナルトレーニングの記事をもっと見る",
  },

  // ── コーチングブログセクション ──────────────────────────────────
  {
    _id: "blogCoachingSection",
    _type: "blogCoachingSection",
    sectionTitle: "思考と習慣を変えるコーチングブログ",
    subheading: "",
    linkText: "コーチングの記事をもっと見る",
  },
  ...
  // ── 3つのサポート ────────────────────────────────────────────────
  {
    _id: "blogSupport",
    _type: "blogSupport",
    sectionTitle: "VERDE FITの3つのサポート",
    items: [
      { _key: "s1", label: "整体", desc: "国家資格保有者による根本改善の整体施術", buttonText: "詳しく見る" },
      { _key: "s2", label: "パーソナルトレーニング", desc: "完全個別指導で理想の身体づくりを実現", buttonText: "詳しく見る" },
      { _key: "s3", label: "コーチング", desc: "思考を変え、習慣をデザインする", buttonText: "詳しく見る" },
    ],
  },
