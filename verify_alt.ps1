...
$query = '*[_type in ["hero","profile","chiropracticHero","chiropracticProfile","personalHero","personalTrainer","services","reasons","chiropracticReasons","testimonials","personalBeforeAfter"]]{_type,imageAlt,serviceList[]{_key,imageAlt},reasonList[]{_key,imageAlt},voiceList[]{_key,imageAlt},cards[]{_key,imageAlt}}'
