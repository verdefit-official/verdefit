...
const faqItems = [
  {
    ...
    answer:
      "はい、もちろん大丈夫です。横手市のVERDE FITでは、お客様の8割以上が運動未経験または久しぶりの方です。体力レベルに合わせて、無理のないプログラムを作成しますので安心してご参加ください。",
  },
  {
    key: "q2",
    question: "食事制限は厳しいですか？",
    answer:
      "厳しい食事制限は行いません。一生続けられる食事管理を身につけることを目標にしています。外食が多い方、料理が苦手な方でも実践できる、現実的な食事管理をサポートします。",
  },
  {
    key: "q3",
    question: "どのくらいで効果が出ますか？",
    answer:
      "個人差はありますが早い方では1〜2か月で身体の変化を実感される方も多いです。体重だけでなく、体型や体調の変化も感じていただけるようサポートします。",
  },
  {
    key: "q4",
    question: "リバウンドはしませんか？",
    answer:
      "無謀なダイエットではなく、運動と食事の習慣化を重視しているためリバウンドしにくい身体づくりを目指します。卒業後も続けられる習慣を身につけていただきます。",
  },
  {
    key: "q5",
    question: "駐車場はありますか？",
    answer:
      "はい、専用駐車場を完備しております。駐車場の場所は予約時にご案内いたします。",
  },
  {
    key: "q6",
    question: "どんな服装で行けばいいですか？",
    answer:
      "動きやすい服装と室内シューズをご用意ください。お飲み物もあると安心です。",
  },
  {
    key: "q7",
    question: "子供を連れて行っても大丈夫ですか？",
    answer:
      "はい、大丈夫です。院内にキッズスペースをご用意しており、トレーニング中は女性スタッフがお子様を見守りますので安心して施術を受けていただけます。ご予約時にお子様連れの旨をお知らせください。",
  },
  {
    key: "q8",
    question: "分割払いは可能ですか？",
    answer:
      "はい、可能です。クレジットカードでの分割払いにも対応しております。詳しくはカウンセリング時にご相談ください。",
  },
];
