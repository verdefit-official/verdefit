...
export default function CTA({ data, phone, bookingUrl, lineUrl, subheading, plain }: { data?: CTAData | null; phone?: string; bookingUrl?: string; lineUrl?: string; subheading?: string; plain?: boolean }) {
  ...
  const inner = (
    <>
      ...
      <p className="mx-auto mt-8 max-w-3xl whitespace-pre-line text-sm leading-8 text-gray-700 md:text-base md:leading-9">
        {description}
      </p>
