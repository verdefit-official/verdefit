...
export const metadata: Metadata = {
  title: "ブログ｜横手市VERDE FIT",
  description:
    "横手市の整体・パーソナルトレーニング・コーチング専門家が、健康づくりに役立つ情報をお届けします。肩こり・腰痛・姿勢改善・ダイエット・習慣改善など身体の悩みを解決するヒントが満載です。",
  openGraph: {
    title: "ブログ｜横手市VERDE FIT",
    description:
      "横手市の整体・パーソナルトレーニング・コーチング専門家が、健康づくりに役立つ情報をお届けします。",
    locale: "ja_JP",
    type: "website",
  },
};
