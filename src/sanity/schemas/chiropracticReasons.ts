      ...
      of: [
        {
          ...
          fields: [
            ...
            defineField({ name: "description", title: "説明文", type: "text", rows: 5, description: "例: 柔道整復師の国家資格を持つ施術者が、骨格・姿勢・筋肉のバランスを整え、再発しにくい身体をつくります。" }),
            defineField({
              name: "image",
              title: "画像",
              type: "image",
            ...
            defineField({ name: "imageAlt", title: "画像の代替テキスト", type: "string", description: "例: 施術者が患者の背中を施術している様子" }),
          ],
          preview: {
            select: { title: "title" },
          },
